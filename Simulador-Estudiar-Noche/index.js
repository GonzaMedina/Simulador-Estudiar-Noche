alert("¡Haz clic en los interruptores y en el libro! ")
alert("Por favor, no se preocupe si se ve un poco extraño debido a los diferentes anchos y altos de los dispositivos.")
